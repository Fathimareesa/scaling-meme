...
top 10 countries with the highest volume of Android installs in the current reporting year.
...
Play. PHA installs represent <1% of the overall app installs across all
Android devices with Google Play Protect.

number-and-percentage-of-models-with-90-day-security-updates.csv

This file shows both the number and percentage of models launched with a 90-day or newer
